...
Page({
   ...
   */
    ...
    async _bindSave() {
    // 提交保存
        const comName = this.data.comName;
        const tfn = this.data.tfn;
        const mobile = this.data.mobile;
        const amount = this.data.amount;
        const consumption = this.data.consumption;
        ...
        const extJsonStr = { "api工厂账号": mobile,  "地址与电话": address,  "开户行与账号": bank, };
        WXAPI.invoiceApply({
