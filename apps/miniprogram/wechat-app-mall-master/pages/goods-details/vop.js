...
Page({
    ...
    async getGoodsDetailAndKanjieInfo(goodsId) {
        ...
        if (this.data.goodsId2) {
            const goodsDetailRes = await WXAPI.goodsDetail(this.data.goodsId2, token || "");
   ...
   */
    buliduBuyNowInfo(shoptype) {
        const shopCarMap = { goodsId: this.data.goodsId,  pic: this.data.imageDomain + this.data.price.pic,  name: this.data.price.skuName,  price: this.data.price.priceSale,  left: "",  active: true,  number: this.data.buyNumber, };

        const buyNowInfo = { shopNum: 0,  shopList: [ shopCarMap ], };
