<template>
    <view v-if="modelValue" class="fly-login">
        <view class="fly-login-mask" />
        <view class="fly-login-content px-4">
            <view class="font-bold h-16 leading-16">
                获取您的昵称、头像
            </view>
            <view class="rounded-full bg-light-600 w-6 h-6 text-center absolute top-4 right-4"
                  @click="onClose">
                <view class="i-carbon-close text-gray-700" />
            </view>

            <view class="flex items-center h-16 leading-16 border-b-gray-400 border-b-solid border-[1rpx]">
                <text class="mr-4 flex-shrink-0">头像</text>
                <button class="bg-transparent flex items-center after:b-none w-full h-12 leading-12"
            ...
            <view class="flex items-center h-16 leading-16 border-b-gray-400 border-b-solid border-1 mt-4">
            ...
            <button class="text-center leading-12 w-40 my-4"
                    size="default"
