...
<template>
    <view class="content">
        ...
        <view class="charts-box">
            ...
            <qiun-data-charts :chart-data="chartsDataLine1"
                              :echarts-app="true"
                              :echarts-h5="true"
        ...
        <view class="charts-box">
            ...
            <qiun-data-charts :chart-data="chartsDataColumn2"
                              :echarts-app="true"
                              :echarts-h5="true"
    ...
    methods: {
        getServerData() {
            setTimeout(() => {
                ...
                this.chartsDataLine1 = structuredClone(demodata.Line);
                this.chartsDataColumn2 = structuredClone(demodata.Column);
            }, 1500);
        },
    },
};
