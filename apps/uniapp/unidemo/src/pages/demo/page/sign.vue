    ...
    <view class="canvas-box flex flex-col box-border p-3" :class="{ 'full-screen': isFullScreen }">
        ...
        <view class="btns flex justify-between text-center box-border">
            <view class="btn-box flex">
                ...
                <view class="btn bg-gray-100 b-rd b-gray-300 c-gray-500 p-1 ml-2" @click="clear">
                    清空
                </view>
            ...
            <view class="btn-box flex">
                <view class="btn bg-sky-500 b-rd c-white p-1" @click="save">
                    保存
                </view>
            </view>
        </view>
...
function draw(w?) {
    ...
    if (!w) {
        allPoints[allPoints.length - 1].push(structuredClone(points) );
    }
