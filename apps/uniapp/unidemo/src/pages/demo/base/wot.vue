...
<template>
    <view class="center pt-4 flex-col">
        ...
        <wd-curtain src="https://via.placeholder.com/400x200.png/3c9cff/fff"
                    :value="value"
                    :width="300"
                    @close="handleClose">
        </wd-curtain>
        ...
        <view class="flex m-4">
            ...
            <wd-icon color="red" name="add-circle"></wd-icon>
            <wd-icon class="text-green" name="add-circle"></wd-icon>
            <wd-icon class="text-green"
                     color="red"
                     name="add-circle">
            </wd-icon>
            <wd-icon class="text-green w-10 h-10"
                     color="red"
                     name="add-circle">
            </wd-icon>
        ...
        <view class="mt-4" @click="closeOutside">
            <wd-popover v-model="show"
