...
<template>
    <view class="mt-10">
        <uv-button type="primary" @click="remakeQc">
            重新生成二维码
        </uv-button>
        ...
        <view class="m-4 flex">
            ...
            <uv-icon color="red" name="home"></uv-icon>
            <uv-icon class="text-green" name="home"></uv-icon>
            <uv-icon class="text-green"
                     color="red"
                     name="home">
            </uv-icon>
            <uv-icon class="text-green"
            ...
            <uv-icon class="text-green w-10 h-10"
                     color="red"
                     name="home"
                     size="20">
            </uv-icon>
            <uv-icon class="text-green w-20 h-20"
                     color="red"
                     name="home">
            </uv-icon>
            <uv-icon class="text-green w-10"
                     color="red"
                     name="home"
                     size="20">
            </uv-icon>
