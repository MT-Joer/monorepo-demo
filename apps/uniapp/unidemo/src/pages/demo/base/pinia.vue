...
<template>
    <view class="flex justify-center items-center text-blue-500 mt-4 mb-4">
        ...
        <button class="ml-2 mr-2" @click="countStore.decrement">
            -1
        </button>
        <button class="ml-2 mr-2" @click="countStore.increment">
            +1
        </button>
        <button class="ml-2 mr-2" @click="countStore.reset">
            重置
        </button>
    </view>
    <view class="m-8 text-4 leading-8">
        ...
        <button @click="setUserInfo">
            设置UserInfo
        </button>
        <button class="mt-4" @click="clearUserInfo">
            清除UserInfo
        </button>
        <button class="mt-4" @click="resetUserStore">
            reset UserStore
        </button>
    </view>
</template>
