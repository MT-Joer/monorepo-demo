    ...
    <view class="bg-slate-100 min-h-full box-border pb-1">
        ...
        <view class="bg-slate-100 px-4 pt-3">
            <view class="list-container">
                <view v-for="item in currContentList"
                      :key="item.path"
                      class="mb-3">
                    <view class="flex bg-white items-center justify-between p-3 mb-2"
