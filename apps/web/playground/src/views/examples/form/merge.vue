<template>
    <Page description="表单组件合并示例：在某些场景下，例如分步表单，需要合并多个表单并统一提交。默认情况下，使用 Object.assign 规则合并表单。如果需要特殊处理数据，可以传入 false。"
          title="表单组件">
        <Card title="基础示例">
            <template #extra>
                <Switch v-model="needMerge"
            ...
            <div class="mx-auto max-w-lg">
                <Steps class="steps" :current="currentTab">
                    <Step title="表单1" />
                    <Step title="表单2" />
                </Steps>
                <div class="p-20">
