    ...
    <Page title="Tippy">
        ...
        <Card title="指令形式使用">
            ...
            <Flex align="center"
                ...
                <Button v-tippy="{ theme: 'light', content: '这是一个提示，总是light主题' }">
                    指定主题
                </Button>
                <Button v-tippy="{
                    theme: 'light',
        ...
        <Card class="mt-4" title="组件形式使用">
            ...
            <Form class="mt-4" />
            <template #actions>
                <p class="cursor-default text-secondary-foreground hover:text-secondary-foreground">
                    更多配置请
                    <Button size="small"
                            type="link"
                            @click="goDoc">
