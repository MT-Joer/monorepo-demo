    ...
    <Page auto-content-height
        ...
        <Flex class="w-full"
            ...
            <Card class="w-[300px]" title="基本使用">
                <p>一个基础的弹窗示例</p>
                <template #actions>
                    <Button type="primary" @click="openBaseModal">
                        打开弹窗
                    </Button>
                </template>
            </Card>
            ...
            <Card class="w-[300px]" title="指定容器+关闭后不销毁">
                <p>在内容区域打开弹窗的示例</p>
                <template #actions>
                    <Button type="primary" @click="openInContentModal">
                        打开弹窗
                    </Button>
                </template>
            </Card>
            ...
            <Card class="w-[300px]" title="动态配置示例">
                ...
                <template #extra>
                    <Button type="link" @click="openDynamicModal">
                        打开弹窗
                    </Button>
                </template>
                <template #actions>
            ...
            <Card class="w-[300px]" title="遮罩模糊示例">
                <p>遮罩层应用类似毛玻璃的模糊效果</p>
                <template #actions>
                    <Button type="primary" @click="openBlurModal">
                        打开弹窗
                    </Button>
                </template>
            </Card>
            <Card class="w-[300px]" title="轻量提示弹窗">
                ...
                <template #actions>
                    <Button type="primary" @click="openAlert">
                        Alert
                    </Button>
                    <Button type="primary" @click="openConfirm">
                        Confirm
                    </Button>
                    <Button type="primary" @click="openPrompt">
                        Prompt
                    </Button>
                </template>
            </Card>
