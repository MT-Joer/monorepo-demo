<template>
    ...
    <SwitchItem v-model="sidebarExpandOnHover"
    ...
    <SwitchItem v-model="sidebarAutoActivateChild"
                :disabled="
                    !sidebarEnable ||
    ...
    <CheckboxItem v-model="sidebarButtons"
                  :items="[
    ...
    <NumberFieldItem v-model="sidebarWidth"
