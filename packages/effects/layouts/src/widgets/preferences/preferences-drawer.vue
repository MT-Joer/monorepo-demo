<template>
    <div>
        <Drawer class="!border-0 sm:max-w-sm"
                                    ...
                                    @click="
                                        () =>
                                            (appEnableStickyPreferencesNavigationBar =
                                                !appEnableStickyPreferencesNavigationBar)
                                    ">
                        <PinOff v-if="appEnableStickyPreferencesNavigationBar"
                                class="size-4" />
            ...
            <div>
                <VbenSegmented v-model="activeTab"
                               :class="{
                    ...
                    <template #general>
                        <Block :title="$t('preferences.general')">
                            <General v-model:app-dynamic-title="appDynamicTitle"
                        ...
                        <Block :title="$t('preferences.animation.title')">
                            <Animation v-model:transition-enable="transitionEnable"
                    ...
                    <template #appearance>
                        ...
                        <Block :title="$t('preferences.theme.builtin.title')">
                            <BuiltinTheme v-model="themeBuiltinType"
                        ...
                        <Block :title="$t('preferences.other')">
                            <ColorMode v-model:app-color-gray-mode="appColorGrayMode"
                    ...
                    <template #layout>
                        ...
                        <Block :title="$t('preferences.sidebar.title')">
                            <Sidebar v-model:sidebar-auto-activate-child="sidebarAutoActivateChild"
                        ...
                        <Block :title="$t('preferences.header.title')">
                            <Header v-model:header-enable="headerEnable"
                        ...
                        <Block :title="$t('preferences.navigationMenu.title')">
                            <Navigation v-model:navigation-accordion="navigationAccordion"
                        ...
                        <Block :title="$t('preferences.breadcrumb.title')">
                            <Breadcrumb v-model:breadcrumb-enable="breadcrumbEnable"
                        ...
                        <Block :title="$t('preferences.tabbar.title')">
                            <Tabbar v-model:tabbar-draggable="tabbarDraggable"
                        ...
                        <Block :title="$t('preferences.footer.title')">
                            <Footer v-model:footer-enable="footerEnable"
                                    v-model:footer-fixed="footerFixed" />
                        </Block>
                        <Block v-if="copyrightSettingShow"
                               :title="$t('preferences.copyright.title')">
                            <Copyright v-model:copyright-company-name="copyrightCompanyName"
                    ...
                    <template #shortcutKey>
                        <Block :title="$t('preferences.shortcutKeys.global')">
                            <GlobalShortcutKeys v-model:shortcut-keys-enable="shortcutKeysEnable"
