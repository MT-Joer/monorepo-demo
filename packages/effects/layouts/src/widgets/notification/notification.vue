    ...
    <VbenPopover v-model:open="open"
        ...
        <div class="relative">
            <div class="flex items-center justify-between p-4 py-3">
                ...
                <VbenIconButton :disabled="notifications.length <= 0"
                ...
                <ul class="!flex max-h-[360px] w-full flex-col">
                    <template v-for="item in notifications" :key="item.id ?? item.title">
                        <li class="hover:bg-accent border-border relative flex w-full cursor-pointer items-start gap-5 border-t px-3 py-3"
                            ...
                            <div class="absolute right-3 top-1/2 flex -translate-y-1/2 flex-col gap-2">
                                <VbenIconButton v-if="!item.isRead"
                                                class="h-6 px-2"
                                                size="xs"
            ...
            <div class="border-border flex items-center justify-between border-t px-4 py-3">
                <VbenButton :disabled="notifications.length <= 0"
                            size="sm"
                            variant="ghost"
                            @click="handleClear">
