<template>
    <VbenAdminLayout v-model:sidebar-extra-visible="sidebarExtraVisible"
        ...
        <!-- logo -->
        <template #logo>
            <VbenLogo v-if="preferences.logo.enable"
                      :class="logoClass"
        ...
        <template #header>
            <LayoutHeader :theme="theme"
                ...
                <template v-if="!showHeaderNav && preferences.breadcrumb.enable"
                          #breadcrumb>
                    <Breadcrumb :hide-when-only-one="preferences.breadcrumb.hideOnlyOne"
                                :show-home="preferences.breadcrumb.showHome"
                                :show-icon="preferences.breadcrumb.showIcon"
                                :type="preferences.breadcrumb.styleType" />
                </template>
                <template v-if="showHeaderNav" #menu>
                    <LayoutMenu class="w-full"
        ...
        <!-- 侧边菜单区域 -->
        <template #menu>
            <LayoutMenu :accordion="preferences.navigation.accordion"
        ...
        <template #mixed-menu>
            <LayoutMixedMenu :active-path="extraActiveMenu"
        ...
        <!-- 侧边额外区域 -->
        <template #side-extra>
            <LayoutExtraMenu :accordion="preferences.navigation.accordion"
        ...
        <template v-if="preferences.footer.enable" #footer>
            <LayoutFooter>
                <Copyright v-if="preferences.copyright.enable"
        ...
        <template #extra>
            ...
            <CheckUpdates v-if="preferences.app.enableCheckUpdates"
