<template>
    <div>
        <Modal class="border-none px-10 py-6 text-center shadow-xl sm:w-[600px] sm:rounded-2xl md:h-[unset]"
               :closable="false"
               ...
               :header="false"
               :z-index="getZIndex">
            <VbenAvatar class="mx-auto mb-6 size-20" :src="avatar" />
            <Slot :show-forget-password="false"
                  :show-register="false"
