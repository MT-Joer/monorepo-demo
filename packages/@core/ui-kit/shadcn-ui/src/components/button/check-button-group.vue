<template>
    <VbenButtonGroup class="vben-check-button-group"
                     :gap="props.gap"
                     :size="props.size">
        <Button v-for="(btn, index) in props.options"
                :key="index"
            ...
            <div v-if="props.showIcon" class="icon-wrapper">
                <slot :checked="innerValue.includes(btn.value)"
                      :loading="loadingValues.includes(btn.value)"
                      name="icon">
                    <LoaderCircle v-if="loadingValues.includes(btn.value)"
                                  class="animate-spin" />
