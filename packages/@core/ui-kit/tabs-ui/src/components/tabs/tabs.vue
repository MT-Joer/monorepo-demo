<template>
    <div class="relative !flex h-full w-max items-center overflow-hidden pr-6"
         :class="contentClass">
            ...
            <div v-for="(tab, i) in tabsView"
                ...
                <VbenContextMenu :handler-data="tab"
                    ...
                    <div class="relative flex size-full items-center">
                        ...
                        <!-- tab-item-main -->
                        <div class="mx-3 mr-4 flex h-full items-center overflow-hidden rounded-tl-[5px] rounded-tr-[5px] pr-3 text-accent-foreground transition-all duration-300 group-[.is-active]:text-primary dark:group-[.is-active]:text-accent-foreground">
