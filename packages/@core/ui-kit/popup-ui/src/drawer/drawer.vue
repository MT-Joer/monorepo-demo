<template>
    <Sheet :modal="false"
        ...
        <SheetContent :append-to="getAppendTo"
                      :class="
            ...
            <SheetHeader v-if="showHeader"
                ...
                <div class="flex items-center">
                    <SheetClose v-if="closable && closeIconPlacement === 'left'"
                                as-child
                    ...
                    <Separator v-if="closable && closeIconPlacement === 'left'"
                               class="ml-1 mr-2 h-8"
                               decorative
                ...
                <div class="flex-center">
                    ...
                    <SheetClose v-if="closable && closeIconPlacement === 'right'"
                                as-child
                                class="ml-[2px] cursor-pointer rounded-full opacity-80 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-secondary"
                                :disabled="submitting">
                        <slot name="close-icon">
            ...
            <SheetFooter v-if="showFooter"
                ...
                <slot name="footer">
                    <component :is="components.DefaultButton || VbenButton"
                    ...
                    <component :is="components.PrimaryButton || VbenButton"
