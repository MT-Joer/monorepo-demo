<template>
    <div class="relative flex min-h-full w-full">
        <LayoutSidebar v-if="sidebarEnableState"
        ...
        <div ref="contentRef"
            ...
            <div class="overflow-hidden transition-all duration-200"
                ...
                <LayoutHeader v-if="headerVisible"
                    ...
                    <template #toggle-button>
                        <VbenIconButton v-if="showHeaderToggleButton"
                ...
                <LayoutTabbar v-if="tabbarEnable"
                              :height="tabbarHeight"
                              :style="tabbarStyle">
            ...
            <!-- </div> -->
            <LayoutContent :id="idMainContent"
            ...
            <LayoutFooter v-if="footerEnable"
                          :fixed="footerFixed"
                          :height="footerHeight"
                          :show="!isFullContent"
                          :width="footerWidth"
