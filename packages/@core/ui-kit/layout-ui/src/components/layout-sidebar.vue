<template>
    ...
    <aside class="fixed left-0 top-0 h-full transition-all duration-150"
           :class="[
               theme,
               {
        ...
        <SidebarFixedButton v-if="!collapse && !isSidebarMixed && showFixedButton"
        ...
        <SidebarCollapseButton v-if="showCollapseButton && !isSidebarMixed"
                               v-model:collapsed="collapse" />
        <div v-if="isSidebarMixed"
             ref="asideRef"
             ...
             :style="extraStyle">
            <SidebarCollapseButton v-if="isSidebarMixed && expandOnHover"
                                   v-model:collapsed="extraCollapse" />

            <SidebarFixedButton v-if="!extraCollapse"
                                v-model:expand-on-hover="expandOnHover" />
            <div v-if="!extraCollapse"
                 class="pl-2"
                 :style="extraTitleStyle">
                <slot name="extra-title"></slot>
            </div>
            <VbenScrollbar class="border-border py-2"
                           shadow
                           shadow-border
